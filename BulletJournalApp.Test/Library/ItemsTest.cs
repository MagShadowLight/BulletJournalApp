...
namespace BulletJournalApp.Test.Library
{
    ...
    {
        [Theory]
        [MemberData(nameof(ItemsFixture.GetValidItemsForCreation), MemberType =typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetItemsWithEmptyString), MemberType = typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetItemsWithInvalidQuantityForCreation), MemberType = typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetValidItemsForUpdate), MemberType = typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetItemsWithEmptyStringForUpdating), MemberType = typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetItemsWithInvalidQuantityForUpdating), MemberType = typeof(ItemsFixture))]
        ...
        [Theory]
        [MemberData(nameof(ItemsFixture.GetItemsForMarkingBought), MemberType = typeof(ItemsFixture))]
